...
//!
//! cargo build --target="armv7-unknown-linux-gnueabihf" --example "pmcnv-dq16src-v000002" --release; scp target/armv7-unknown-linux-gnueabihf/release/examples/pmcnv-dq16src-v000002 root@target:/root
