...
На @plate_led_size[рисунке] показаны габаритные размеры плат светодиодов #link(<PMLED-10>)[PMLED-10] и #link(<PMLED-18>)[PMLED-18]. Плата крепится к основной плате с помощью стоек диаметром 2 мм.
