#import "../doc/functions.typ": i2c, listing
#import "../doc/load_pcb_data.typ": load_pcb_data

#let article = "PMCPU-LLP"
#let version = "0.1.0"
...
== #article - контроллер на базе Luckfox Lyra / Luckfox Lyra Plus <PMCPU-LLP>
...
#figure(
  ...
  table(
    ...
    table.header(
      repeat: true,
      [*Сигнал*], [*Rockchip matrix*], [*GPIO устройство; линия*],
    ),
...
#figure(
  ...
  table(
    ...
    table.header(
      repeat: true,
      [*Интерфейс*], [*Путь в системе*], [*Описание*],
    ),

    [#spi0], [`/dev/spidev0.0`], [Шина IBus],

    [#i2c0], [`/dev/i2c-0`], [Шина IBus],

    [#i2c1], [`/dev/i2c-1`], [Подключение кнопок, RTC],

    [#i2c2], [`/dev/i2c-2`], [Настроен в прошивке по умолчанию, нужен для работы тач-контроллера],

    [#can0], [`/dev/can0`], [Шина EBus],

    [#can1], [`/dev/can1`], [Внешний интерфейс CAN],

    [#uart1], [`/dev/ttyS1`], [Внешний интерфейс UART],

    [#uart2], [`/dev/ttyS2`], [Внешний интерфейс UART],
  ),
)
...
#listing(
  ...
  label: <device_tree_llp>,
  breakable: false,
)

#figure(
  caption: "Распиновка Luckfox Lyra Plus",
  image("../doc/images/Luckfox-Lyra-Plus-details-inter-en-d673a0a10e6ce4ce348bc759f27d844e.jpg"),
