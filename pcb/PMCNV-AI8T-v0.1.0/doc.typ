...
#let article = "PMCNV-AI8T"
#let version = "0.1.0"

#pagebreak()

== #article - 8 аналоговых входов (термопары) <PMCNV-AI8T>

=== Опции

#let options = (
  (
    desc: "Тип термопары канал CH0",
    choices: (
      (name: "x", desc: "Без термопары", price: 0),
      (name: "K", desc: "Тип K", price: 5),
      (name: "T", desc: "Тип T", price: 10),
    ),
  ),
)
...
#figure(
  ...
  image("../doc/images/cold_junction.png", width: 100%),
) <cold_junction>
...
#figure(
  ...
  image("../doc/images/PMCNV-AI4T_bias_generator.png", width: 100%),
) <bias_generator>
...
#figure(
  caption: "Цепи защиты",
  image("../doc/images/PMCNV-AI4T_protection_circuit.png", width: 100%),
) <bias_generator>
