...
#let name = "PMMCU-ESP32C3"

#pagebreak()

== #name - микроконтроллер ESP32 <PMMCU-ESP32C3>
...
Плата микроконтроллера подключается к плате конвертирования через 2 12-пиновых разъема FFC. На разъемы выведены протоколы SPI и #i2c (@ch_between_plates[раздел]).
