...
== #name - 16 дискретных входов (PNP) <PMCNV-DI16sink>
...
#let pmcnv_di16sink_power = calc_power_consumtion(power_consumption)
#table_power_consumtion(values: pmcnv_di16sink_power)
