...
/ CMTI: Common Mode Transient Immunity - устойчивость к переходным процессам.
/ #i2c: Inter-Integrated Circuit - последовательная асимметричная шина для связи между интегральными схемами.
