...
#import "functions.typ": all_pcb_data, calc_power_consumtion, i2c, listing, table_power_consumtion
#import "table_options.typ": bom_options, table_options

#let name = "PMCPU-ESP32C3"

#pagebreak()

== #name - CPU на базе микроконтроллера ESP32-C3 <PMCPU-ESP32C3>
