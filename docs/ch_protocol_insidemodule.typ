...
Наиболее распространенными протоколами обмена между интегральными схемами являются SPI и #i2c. Разработанная плата #link(<PMMCU-ESP32C3>)[PMMCU-ESP32C3] позволяет подключать платы конвертирования по обоим протоколам.
