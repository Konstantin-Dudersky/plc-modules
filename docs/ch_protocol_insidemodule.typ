...
Наиболее распространенные протоколы обмена между интегральными схемами являются SPI и #i2c. Разработанная плата #link(<PM_MCU-ESP32_C3>)[PM_MCU-ESP32_C3] позволяет подключать платы конвертирования по обоим протоколам.
